import { xpEngine } from './src/modules/gamification/XPEngine.js';
import { EventType } from './src/modules/gamification/rules/Rule.js';

function verifyRuleEngine() {
  console.log('--- Verifying XP Rule Engine ---');
